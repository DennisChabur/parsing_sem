'''
Ваша задача - создать Python-сценарий, который извлекает данные по каждому фильму
( по каждой ссылке, сохраненной в url_joined) и сохраняет их в JSON-файл.
...
- сохраните извлеченные данные в JSON-файл с именем 'box_office_data.json'.
'''
